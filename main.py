...
class CheckIn(object):
    ...
    sign_url = (
        "https://api.cloud.189.cn/mkt/userSign.action?rand=%s" "&clientType=TELEANDROID&version=8.6.3&model=SM-G930K"
    )
...
if __name__ == "__main__":
    ...
    helper = CheckIn(username, str(base64.b64decode(password), "utf-8"))
    helper.check_in()
